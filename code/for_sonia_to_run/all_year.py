...
preped_dataset.direc=r"C:\Users\usuari\Desktop\10_12_2020\iso_models\12_12_2020\all_year_output_exc_outliers_Year" 
##########################################################################################################################
#colgas meeo model:
...
iso_meteo_model.iso_predic(preped_dataset,run_iso_whole_year=True,iso_model_month_list=[]) #run_iso_whole_year=False,iso_model_month_list=[1,2,3,12]
##########################################################################################################################
#iso model
...
ev_class.predict(iso_meteo_model,pred_inputs,direc=r"C:\Users\usuari\Desktop\10_12_2020\iso_models\12_12_2020\predictions\preds_all_year_obs")
...
ev_class_.predict(iso_meteo_model,pred_inputs,direc=r"C:\Users\usuari\Desktop\10_12_2020\iso_models\12_12_2020\predictions\preds_all_year_map")
#cambia esta linea si quieres correr para hacer el mapa grande de prediction:
